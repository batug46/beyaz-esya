...
export default function Newsletter() {
    return (
        <section className="py-24 sm:py-32 bg-[var(--surface)] relative overflow-hidden">
            <div className="absolute inset-0 mesh-bg opacity-10"></div>
            <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h3 className="text-3xl sm:text-5xl font-black text-[var(--text-main)] mb-6 uppercase tracking-tighter">
                    İnovasyonu <span className="text-accent">Takip Edin</span>
                </h3>
                <p className="text-[var(--text-dim)] text-base sm:text-lg mb-12 max-w-2xl mx-auto font-medium">
